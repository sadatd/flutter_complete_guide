...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (productId != null) {
        // We have ID, thus we edit existing product
        _editedProduct =
  ...
  Future<void> _saveForm() async {
    ...
    if (_editedProduct.id != null) {
      ...
      try {
        ...
        await showDialog(
          // We return because we want to close after user pressed OK
          context: context,
      ...
      // Not used anymore as we have same code after if/else block
      // finally {
      //   setState(() {
      //     _isLoading = false;
      //   });
